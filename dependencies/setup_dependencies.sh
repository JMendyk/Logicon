...
##### DevIL #####
# Current version of DevIL contains a bug that makes it impossible
# to link it as a static library hence I (@JMendyk) applied manual fix.
# There is a pull request submitted to fix this bug already:
# https://github.com/DentonW/DevIL/pull/59
# For the time being, this script will not download/update DevIL.
